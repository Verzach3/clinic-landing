import {
  ...
  const mockdata = [
    ...
    {
      title: '2. Pruebas científicas integrales',
      description:
    ...
    {
        title: '4. Medicamentos entregados en su puerta',
        description:
          'Los medicamentos y suministros llegan a usted, lo que le permite comenzar su plan de bienestar lo más rápido posible.',
        icon: GiMedicines,
      },
      {
